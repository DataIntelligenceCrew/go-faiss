# can be run like:
# docker build -t go-faiss -f Dockerfile .
...
RUN git clone https://github.com/orihabAnyvision/go-faiss.git
...
RUN sudo apt-get -y install libopenblas-dev libomp-dev

RUN pip install numpy faiss
